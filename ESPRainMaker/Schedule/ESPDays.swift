...
class ESPWeek: Codable {
    let daysInWeek: [ESPDay] = [ESPDay(day: "Lunes"), ESPDay(day: "Martes"), ESPDay(day: "Miércoles"), ESPDay(day: "Jueves"), ESPDay(day: "Viernes"), ESPDay(day: "Sábado"), ESPDay(day: "Domingo")]
    ...
    func getShortDescription() -> String {
        ...
        if desc == "Sab, Dom" {
            desc = "Fines de Semana"
        } else if desc == "Lun, Mar, Mie, Jue, Vie" {
            desc = "Días Hábiles"
        }
        return desc
    }
