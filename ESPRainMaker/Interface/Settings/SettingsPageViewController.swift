...
class SettingsPageViewController: UIViewController {
    ...
    @IBAction func signOut(_: Any) {
        let alertController = UIAlertController(title: "Cerrar Sesión", message: "Desea Proceder?", preferredStyle: .alert)
        let cancelAction = UIAlertAction(title: "No", style: .default, handler: nil)
        let confirmAction = UIAlertAction(title: "Si", style: .destructive) { _ in
            DispatchQueue.main.async {
                Utility.showLoader(message: "Cerrando Sesión", view: self.view)
            }
