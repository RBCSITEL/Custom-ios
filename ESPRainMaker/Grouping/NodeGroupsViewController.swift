...
extension NodeGroupsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.deviceCountLabel.text = "\(totalDeviceCount) Interruptores"
...
extension NodeGroupsViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if editingStyle == .delete {
            ...
            let alertController = UIAlertController(title: "Remover", message: "Está segruo en remover Grupo?", preferredStyle: .alert)
