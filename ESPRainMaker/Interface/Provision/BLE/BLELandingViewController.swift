...
class BLELandingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func scanBleDevices() {
        Utility.showLoader(message: "Buscando Interruptores via Bluetooth..", view: view)
