...
extension AppDelegate {
    ...
    func application(_: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) {
        ...
        apiManager.genericAuthorizedJSONRequest(url: Constants.pushNotification, parameter: ["platform": "APNS_SANDBOX", "mobile_device_token": token], method: .post) { response, error in
